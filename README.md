...
host modules for [wazero](https://github.com/ignis-runtime/wazero).
...
[`wazero.HostFunctionBuilder`](https://pkg.go.dev/github.com/ignis-runtime/wazero#HostFunctionBuilder):
